...
class TestLoadCellBasics:
    ...
    def test_reconfigure_with_defaults(
        self, minimal_config, mock_hx711_library, mock_gpio
    ):
...
class TestHX711Hardware:
    ...
    def test_get_hx711_initialization(self, loadcell_sensor, mock_hx711_library):
        ...
        mock_class.assert_called_with(dout_pin=5, pd_sck_pin=6, channel="A", gain=128)
    ...
    def test_get_hx711_initialization_failure(
...
class TestWeightReadings:
    ...
    @pytest.mark.asyncio
    async def test_get_readings_with_tare_offset(
        self, loadcell_sensor, mock_hx711_library
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_readings_negative_weight(
        self, loadcell_sensor, mock_hx711_library
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_readings_hardware_error(
        self, loadcell_sensor, mock_hx711_library
    ):
...
class TestViamIntegration:
    ...
    @pytest.mark.asyncio
    async def test_do_command_multiple_commands(
        self, loadcell_sensor, mock_hx711_library
    ):
...
class TestEdgeCasesAndCalculations:
    ...
    @pytest.mark.asyncio
    async def test_weight_calculations(
        self,
        loadcell_sensor,
        mock_hx711_library,
        raw_readings,
    ...
    @pytest.mark.asyncio
    async def test_varying_number_of_readings(
